...
export const adminDataReducer = (state = initialAdminState, action) => {
  switch (action.type) {
    ...
    case adminActionTypes.GET_STUDENTS_SUCCESS:
      ...
      saveAdminState(updatedAdmin5);
      return updatedAdmin5;

    case adminActionTypes.GET_STUDENTS_REQUEST:
      saveAdminState({ ...state, loading: true });
      return { ...state, loading: true };

    case adminActionTypes.GET_ENROLLMENTS_SUCCESS:
      const updatedAdmin6 = {
        ...state,
        enrollments: action.payload.enrollments,
        loading: false,
      };
      saveAdminState(updatedAdmin6);
      return updatedAdmin6;

    case adminActionTypes.GET_ENROLLMENTS_REQUEST:
      saveAdminState({ ...state, loading: true });
      return { ...state, loading: true };

    case adminActionTypes.GET_COURSES_SUCCESS:
      const updatedAdmin = {
        ...state,
    ...
    case adminActionTypes.GET_COURSES_REQUEST:
      saveAdminState({ ...state, loading: true });
      return { ...state, loading: true };

    case adminActionTypes.GET_INSTRUCTORS_SUCCESS:
      const updatedAdmin3 = {
        ...state,
        instructors: action.payload.instructors,
        loading: false,
      };
      saveAdminState(updatedAdmin3);
      return updatedAdmin3;

    case adminActionTypes.GET_INSTRUCTORS_REQUEST:
      saveAdminState({ ...state, loading: true });
      return { ...state, loading: true };

    case adminActionTypes.GET_SUBJECTS_SUCCESS:
      const updatedAdmin4 = {
        ...state,
        subjects: action.payload.subjects,
        loading: false,
      };
      saveAdminState(updatedAdmin4);
      return updatedAdmin4;

    case adminActionTypes.GET_SUBJECTS_REQUEST:
      saveAdminState({ ...state, loading: true });
      return { ...state, loading: true };

    case adminActionTypes.ADD_SUBJECTS_REQUEST: {
      saveAdminState({ ...state, loading: true });
      return { ...state, loading: true };
    }

    case adminActionTypes.ADD_SUBJECTS_SUCCESS: {
      saveAdminState({ ...state, loading: false });
      return { ...state, loading: false };
    }

    case adminActionTypes.ADD_INSTRUCTORS_REQUEST: {
      saveAdminState({ ...state, loading: true });
      return { ...state, loading: true };
    }

    case adminActionTypes.ADD_INSTRUCTORS_SUCCESS: {
      saveAdminState({ ...state, loading: false });
      return { ...state, loading: false };
    }

    case adminActionTypes.ADD_COURSES_REQUEST: {
      saveAdminState({ ...state, loading: true });
      return { ...state, loading: true };
    }

    case adminActionTypes.ADD_COURSES_SUCCESS: {
      saveAdminState({ ...state, loading: false });
      return { ...state, loading: false };
    }
    ...
    case adminActionTypes.GET_PARTICIPANTS_SUCCESS:
      ...
      const updatedEvent = {
        ...
        roundWiseSelectedParticipants,
        teamLeaders,
        roundWiseSelectedTeamLeaders,
      };
